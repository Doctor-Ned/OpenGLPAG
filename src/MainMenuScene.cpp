...
MainMenuScene::MainMenuScene() {
	...
	buttonNewGame = new UiTextButton(SceneManager::getInstance().getUiTextureShader(), BUTTON_LONG_IDLE, BUTTON_LONG_HOVER, BUTTON_LONG_CLICKED, glm::vec2(WINDOW_CENTER_X, WINDOW_HEIGHT * 0.42f)
	...
	buttonOptions = new UiTextButton(SceneManager::getInstance().getUiTextureShader(), BUTTON_LONG_IDLE, BUTTON_LONG_HOVER, BUTTON_LONG_CLICKED, nextPos
		, BUTTON_STANDARD_SIZE, SceneManager::getInstance().getTextRenderer(), "Options");

	nextPos.y += BUTTON_STANDARD_SIZE.y + 10.0f;
	buttonQuit = new UiTextButton(SceneManager::getInstance().getUiTextureShader(), BUTTON_LONG_IDLE, BUTTON_LONG_HOVER, BUTTON_LONG_CLICKED, nextPos
