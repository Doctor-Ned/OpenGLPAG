...
public:
	MeshColorCylinder(Shader shader, float radius, float height, int sideAmount, glm::vec4 color, glm::vec3 baseCenter = glm::vec3(0.0f, 0.0f, 0.0f));
...
protected:
	...
	void createSideTriangles(std::vector<SimpleVertex> *vertices);
